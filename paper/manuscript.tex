...
% \IEEEoverridecommandlockouts  % only needed to identify funding in a \thanks footnote; unused here
...
\title{Reading the Eyes, Not the Mind? A Portable, Montage-Matched Auditor for Ocular Confounds in EEG Decoding}

\author{%
\IEEEauthorblockN{Cooper Lee\IEEEauthorrefmark{1},
Andrew Wong\IEEEauthorrefmark{2},
Luke Yin\IEEEauthorrefmark{3},
Adam Park\IEEEauthorrefmark{1}, and
Yoo Choi\IEEEauthorrefmark{4}}
\IEEEauthorblockA{%
\IEEEauthorrefmark{1}Illinois Mathematics and Science Academy, Aurora, IL, USA\\
\IEEEauthorrefmark{2}University of Michigan, Ann Arbor, MI, USA\\
\IEEEauthorrefmark{3}Princeton University, Princeton, NJ, USA\\
\IEEEauthorrefmark{4}Cornell University, Ithaca, NY, USA\\
Corresponding author: Cooper Lee (clee1@imsa.edu)}%
}
