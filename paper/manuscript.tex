...
{\large Cooper Lee\textsuperscript{1,*}, Andrew Wong\textsuperscript{2}, Luke Yin\textsuperscript{3}, Adam Park\textsuperscript{1}, Yoo Choi\textsuperscript{4}\par}

\vspace{0.6em}

{\small
\textsuperscript{1}Illinois Mathematics and Science Academy, Aurora, IL, USA;\quad
\textsuperscript{2}University of Michigan, Ann Arbor, MI, USA;\quad
\textsuperscript{3}Princeton University, Princeton, NJ, USA;\quad
\textsuperscript{4}Cornell University, Ithaca, NY, USA\par}

\vspace{0.7em}

{\small\textsuperscript{*}\textbf{Corresponding author:} Cooper Lee~(clee1@imsa.edu)\par}
\end{center}
...
All authors contributed to the design, analysis, and writing of the study and approved the final manuscript.
